    ...
    public static class AzureResourceManagerUtil
    {
        ...
        public static string GetUsage(string subscriptionId, string organizationId)
        {
            ...
            try
            {
                ...
                //Get DAILY data for past 1 days
                var startString = System.DateTime.UtcNow.AddDays(-2).GetEncodedDate(false);
                var endString = System.DateTime.UtcNow.GetEncodedDate(false);
                ...
                string requesturl = String.Format("https://management.azure.com/subscriptions/{0}/providers/Microsoft.Commerce/UsageAggregates?api-version=2015-06-01-preview&reportedstartTime={1}&reportedEndTime={2}&aggregationGranularity=Daily&showDetails=true", subscriptionId, startString, endString);
